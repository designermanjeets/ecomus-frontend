...
export const PRODUCT_META_DATA: { [key: number]: ProductMetaData } = {
  ...
  2224: {
    meta_title: "Men’s Athletic Fit Jeans – Stretch Denim | Stylexio",
    meta_description: "Shop Men’s Athletic Fit Jeans online at Stylexio. Stretch denim with roomy thighs & tapered fit for comfort & style. Free shipping in India",
    meta_keywords: "athletic fit jeans men, men’s athletic fit jeans, stretch denim jeans men",
